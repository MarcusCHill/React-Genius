  ...
  return(
      <div id = "yellowHeader">
        <form className="searchBar">
          <input id="searchGenius" placeholder="Search lyrics & more"></input>
          <button className="searchButton">
            <svg src="magnifying_glass.svg" className="searchIcon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 21.48 21.59">
        ...
        <div className="homeLink">
          <a href="www.genius.com">
            <svg className="geniusLogo" viewBox="0 0 100 15">
        ...
        <div className="signUpIn">
          <a href="www.genius.com/signup" className="signUp">SIGN UP</a>
          <a href="www.genius.com/login" className="signIn">SIGN IN</a>
        </div>
      </div>
  )
}
